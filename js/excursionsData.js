export const EXCURSIONS = [
  ...
  { id: 'blue-hole-secret-falls', title: 'Blue Hole (Secret Falls / Island Gully)', category: 'Nature', location: 'St. Ann', duration: '3 hrs', priceFrom: 55, image: 'assets/images/jamaica-luminous-lagoon-trelawny.jpg', summary: 'Blue spring pools, rope swings, and rainforest cascades.' },
  { id: 'ys-falls', title: 'YS Falls', category: 'Nature', location: 'St. Elizabeth', duration: '4 hrs', priceFrom: 60, image: 'assets/images/jamaica-mayfield.jpg', summary: 'Seven-tier waterfall gardens with natural pools and canopy zipline.' },
  { id: 'reach-falls', title: 'Reach Falls', category: 'Nature', location: 'Portland', duration: '4 hrs', priceFrom: 60, image: 'assets/images/jamaica-mountains.jpg', summary: 'River cave and jungle waterfall adventure in eastern Jamaica.' },
  ...
  { id: 'doctors-cave-beach', title: "Doctor's Cave Beach", category: 'Beach', location: 'Montego Bay', duration: 'Half Day', priceFrom: 45, image: 'assets/images/jamaica-lagoon-sunset.jpg', summary: 'Classic Mobay beach club known for turquoise calm water.' },
  { id: 'frenchmans-cove', title: "Frenchman's Cove", category: 'Beach', location: 'Portland', duration: 'Half Day', priceFrom: 60, image: 'assets/images/jamaica-mountains.jpg', summary: 'River-meets-sea cove framed by tropical greenery.' },
  { id: 'boston-bay-beach', title: 'Boston Bay Beach', category: 'Beach', location: 'Portland', duration: 'Half Day', priceFrom: 55, image: 'assets/images/jamaica-river-rafting.jpg', summary: 'Surf-friendly bay near Jamaica\'s jerk heartland.' },
  ...
  { id: 'hellshire-beach', title: 'Hellshire Beach', category: 'Beach', location: 'St. Catherine', duration: 'Half Day', priceFrom: 45, image: 'assets/images/jamaica-pelican-bar.jpg', summary: 'Popular fish beach with local weekend atmosphere.' },
  ...
  { id: 'falmouth-historic-district', title: 'Falmouth Historic District', category: 'Culture', location: 'Trelawny', duration: '2 hrs', priceFrom: 40, image: 'assets/images/jamaica-transfer.jpg', summary: 'Georgian port-town architecture and guided heritage walk.' },
  { id: 'port-royal', title: 'Port Royal', category: 'Culture', location: 'Kingston', duration: '2 hrs', priceFrom: 40, image: 'assets/images/jamaica-lagoon-sunset.jpg', summary: 'Historic pirate city and maritime fort history.' },
  ...
  { id: 'ricks-cafe-dining', title: "Rick's Cafe (sunset + cliff diving + dining)", category: 'Food', location: 'Negril', duration: '3 hrs', priceFrom: 50, image: 'assets/images/jamaica-lagoon-sunset.jpg', summary: 'Sunset dining with iconic cliff-diving scene.' },
  ...
  { id: 'glorias-seafood', title: "Gloria's Seafood", category: 'Food', location: 'Kingston', duration: '2 hrs', priceFrom: 40, image: 'assets/images/jamaica-pelican-bar.jpg', summary: 'Local seafood institution with waterfront energy.' },
  ...
  { id: 'appleton-estate', title: 'Appleton Estate rum tours', category: 'Food', location: 'St. Elizabeth', duration: '4 hrs', priceFrom: 65, image: 'assets/images/jamaica-mountains.jpg', summary: 'Estate-to-glass rum heritage tour and tasting.' },
  ...
  { id: 'tracks-and-records', title: "Usain Bolt's Tracks & Records", category: 'Food', location: 'Kingston', duration: '2 hrs', priceFrom: 40, image: 'assets/images/jamaica-concert.jpg', summary: 'Sports bar dining with nightlife crossover.' },
  ...
  { id: 'luminous-lagoon-swim', title: 'Luminous Lagoon night glow swim', category: 'Adventure', location: 'Falmouth', duration: '2 hrs', priceFrom: 40, image: 'assets/images/jamaica-luminous-lagoon-trelawny.jpg', summary: 'Night swim where the water glows with movement.' },
  { id: 'negril-cliffs-diving', title: 'Negril Cliffs cliff diving', category: 'Adventure', location: 'Negril', duration: '3 hrs', priceFrom: 55, image: 'assets/images/jamaica-beach.jpg', summary: 'Cliff-side viewing and optional guided jump zones.' },
  ...
  { id: 'helicopter-island-tour', title: 'Helicopter tours (island aerial views)', category: 'Luxury', location: 'Island-wide', duration: '1 hr', priceFrom: 450, image: 'assets/images/jamaica-mountains.jpg', summary: 'Aerial Jamaica circuit for premium travelers.' },
  { id: 'tryall-roundhill-villas', title: 'Private villas in Tryall Club / Round Hill', category: 'Luxury', location: 'Montego Bay', duration: 'Custom', priceFrom: 500, image: 'assets/images/jamaica-beach.jpg', summary: 'Private-villa transfer and concierge coordination.' },
  ...
  { id: 'strawberry-hill-spa', title: 'Spa day: Strawberry Hill Spa', category: 'Luxury', location: 'Blue Mountains', duration: 'Half Day', priceFrom: 180, image: 'assets/images/jamaica-mountains.jpg', summary: 'Mountain wellness retreat and scenic spa experiences.' },
  ...
  // Hidden Gems
  { id: 'somerset-falls', title: 'Somerset Falls', category: 'Hidden Gems', location: 'Portland', duration: '3 hrs', priceFrom: 60, image: 'assets/images/jamaica-falls.jpg', summary: 'Boat-in grotto waterfall and quiet tropical gardens.' },
  ...
  { id: 'reggae-falls', title: 'Reggae Falls', category: 'Hidden Gems', location: 'St. Thomas', duration: '3 hrs', priceFrom: 65, image: 'assets/images/jamaica-mountains.jpg', summary: 'Natural falls with local countryside atmosphere.' },
  { id: 'cane-river-falls', title: 'Cane River Falls', category: 'Hidden Gems', location: 'St. Andrew', duration: '2 hrs', priceFrom: 50, image: 'assets/images/jamaica-river-rafting.jpg', summary: 'Off-path waterfall spot ideal for private moments.' },
  { id: 'lovers-leap', title: 'Lovers Leap', category: 'Hidden Gems', location: 'St. Elizabeth', duration: '2 hrs', priceFrom: 45, image: 'assets/images/jamaica-lagoon-sunset.jpg', summary: 'South-coast cliff viewpoint with dramatic sea panoramas.' },
  { id: 'milk-river-bath', title: 'Milk River Bath', category: 'Hidden Gems', location: 'Clarendon', duration: '2 hrs', priceFrom: 45, image: 'assets/images/jamaica-transfer.jpg', summary: 'Mineral-rich thermal bath destination with local history.' },

  // Accessible
  { id: 'emancipation-park', title: 'Emancipation Park (flat + accessible)', category: 'Accessible', location: 'Kingston', duration: '2 hrs', priceFrom: 35, image: 'assets/images/jamaica-culture.jpg', summary: 'Smooth pathways and city-center accessible leisure route.' },
  { id: 'hope-botanical-gardens', title: 'Hope Botanical Gardens', category: 'Accessible', location: 'Kingston', duration: '2 hrs', priceFrom: 35, image: 'assets/images/jamaica-mountains.jpg', summary: 'Mobility-friendly garden paths and shaded open grounds.' },
  ...
  { id: 'doctors-cave-private-setup', title: "Private beach setups at Doctor's Cave", category: 'Accessible', location: 'Montego Bay', duration: 'Half Day', priceFrom: 85, image: 'assets/images/jamaica-beach.jpg', summary: 'Assisted setup for accessible beach comfort and shade.' },
  ...
  { id: 'hope-zoo', title: 'Hope Zoo', category: 'Family', location: 'Kingston', duration: '2 hrs', priceFrom: 35, image: 'assets/images/jamaica-culture.jpg', summary: 'Kid-friendly wildlife visit inside Hope Gardens area.' },
  { id: 'dolphin-cove-family', title: 'Dolphin Cove', category: 'Family', location: 'Ocho Rios', duration: '3 hrs', priceFrom: 90, image: 'assets/images/jamaica-beach.jpg', summary: 'Family marine interaction packages with guided support.' },
  { id: 'mystic-mountain-family', title: 'Mystic Mountain', category: 'Family', location: 'Ocho Rios', duration: '3 hrs', priceFrom: 75, image: 'assets/images/jamaica-mountains.jpg', summary: 'Rainforest rides and activities for mixed-age groups.' },
  ...
  { id: 'caves-restaurant-dinner', title: 'Private dinner at The Caves Restaurant', category: 'Couples', location: 'Negril', duration: 'Evening', priceFrom: 140, image: 'assets/images/jamaica-beach.jpg', summary: 'Romantic cliffside dinner transfer and timing service.' },
  { id: 'blue-lagoon-romance', title: 'Blue Lagoon romance tour', category: 'Couples', location: 'Portland', duration: 'Half Day', priceFrom: 110, image: 'assets/images/jamaica-luminous-lagoon-trelawny.jpg', summary: 'Private lagoon route built for scenic romantic pacing.' },
  { id: 'strawberry-hill-retreat', title: 'Spa + retreat at Strawberry Hill', category: 'Couples', location: 'Blue Mountains', duration: 'Half Day', priceFrom: 180, image: 'assets/images/jamaica-mountains.jpg', summary: 'Spa and mountain retreat for honeymoon-style days.' }
];
